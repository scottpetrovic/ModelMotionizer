...
export default class BoneWeightsByDistance 
{
  ...
  public set_debugging_scene_object(scene_object): void
  {
  ...
  private init_bone_weights_data_structure(bone_hier): void
  {
  ...
  {
    const skinIndices: Array<number> = [];
    const skinWeights: Array<number> = [];
