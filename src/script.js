...
const ui = new UI()
const load_model_step = new StepLoadModel()
const load_skeleton_step = new StepLoadSkeleton()
const edit_skeleton_step = new StepEditSkeleton()
const weight_skin_step = new StepWeightSkin()
